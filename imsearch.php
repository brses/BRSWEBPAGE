...
<html prefix="og: http://ogp.me/ns#" lang="en-GB" dir="ltr">
	<head>
		...
		<meta property="og:url" content="https://brses.com.np/imsearch.php" />
		...
		<link rel="stylesheet" href="pcss/imsearch.css?2021-2-5-0-637640398662306762" media="screen,print" />
	...
	<body>
		<div id="imPageExtContainer">
			<div id="imPageIntContainer">
				...
				<div id="imPage">
					<header id="imHeader">
						<h1 class="imHidden">Search - B.R.S. Engineering Service</h1>
...
About us		</a>
	...
	</li><li class="imMnMnMiddle imPage" data-link-paths=",/our-works.html">
<div class="label-wrapper">
<div class="label-inner-wrapper">
...
Contacts		</a>
	...
	</li><li class="imMnMnLast imLevel"><div class="label-wrapper"><div class="label-inner-wrapper"><span class="label">Forms</span></div></div><ul data-original-position="open-bottom" class="open-bottom" style="" >
	<li class=" imPage" data-link-paths=",/login-forms.php">
<div class="label-wrapper">
<div class="label-inner-wrapper">
		<a class="label" href="login-forms.php">
Login Forms 		</a>
</div>
</div>
...
</div><div id="imHeader_imObjectTitle_02_wrapper" class="template-object-wrapper"><div id="imHeader_imObjectTitle_02"><span id ="imHeader_imObjectTitle_02_text" ><a href="index.html" onclick="return x5engine.utils.location('index.html', null, false)">B.R.S. Engineering Service</a></span></div></div><div id="imHeader_imObjectImage_06_wrapper" class="template-object-wrapper"><div id="imHeader_imObjectImage_06"><div id="imHeader_imObjectImage_06_container">BRS Logo</div></div>
<script>
	x5engine.boot.push(function () {
		$('#imHeader_imObjectImage_06').addClass('imlazyloading').trigger('imLazyLoadingStart');
		new x5engine.mediaObject({
			'url': '211206165160216183098119144097158162211218192165108193232160214239149152163220160',
			'protect': true,
			'load': function ( o ) {
...
</html></div></div><div id="imHeader_imObjectButton_08_wrapper" class="template-object-wrapper"><div id="imHeader_imObjectButton_08"><button type="button" id="imHeader_imObjectButton_08_button" onclick="">Admin Login</button></div></div><div id="imHeader_pluginAppObj_09_wrapper" class="template-object-wrapper"><!-- Social Icons v.16 --><div id="imHeader_pluginAppObj_09">
...
$(function () {$('#imStickyBar_imMenuObject_01_container ul li').not('.imMnMnSeparator').each(function () {    var $this = $(this), timeout = 0;    $this.on('mouseenter', function () {        if($(this).parents('#imStickyBar_imMenuObject_01_container-menu-opened').length > 0) return;         clearTimeout(timeout);        setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeIn(); }, 250);    }).on('mouseleave', function () {        if($(this).parents('#imStickyBar_imMenuObject_01_container-menu-opened').length > 0) return;         timeout = setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeOut(); }, 250);    });});});
...
</div><div id="imStickyBar_imObjectTitle_02_wrapper" class="template-object-wrapper"><div id="imStickyBar_imObjectTitle_02"><span id ="imStickyBar_imObjectTitle_02_text" >B.R.S. Engineering Service</span></div></div></div>
						</div>
					</div>
	...
	<div data-index="0"  class="text-tab-content grid-prop current-tab "  id="imFooter_imTextObject_02_tab0" style="opacity: 1; ">
		<div class="text-inner">
			<div class="imTACenter"><div><span class="fs10lh1-5">Contact Us:</span></div><div><span class="fs10lh1-5">Head Office: Pokhara-30, </span></div><div><span class="fs10lh1-5">Khudi, Kaski</span><br></div><div><span class="fs10lh1-5">Mobile: 9846940514<br></span></div><div><br></div></div>
		</div>
	</div>
	...
	<div data-index="0"  class="text-tab-content grid-prop current-tab "  id="imFooter_imTextObject_03_tab0" style="opacity: 1; ">
		<div class="text-inner">
			<div class="imTACenter"><div><span class="fs10lh1-5">Contact Us:</span></div><div><span class="fs10lh1-5">Branch Office: Pokhara-25, </span></div><div><span class="fs10lh1-5">Hemja, Kaski</span><br></div><div><span class="fs10lh1-5">Mobile: 9815148304</span></div><div><br></div></div>
		</div>
	</div>
	...
	<div data-index="0"  class="text-tab-content grid-prop current-tab "  id="imFooter_imTextObject_04_tab0" style="opacity: 1; ">
		<div class="text-inner">
			<div class="imTACenter"><div><span class="fs10lh1-5">Email us: Support@brses.com.np</span><br></div><div><span class="fs10lh1-5">Head office: +977061560126</span></div></div>
		</div>
	</div>
